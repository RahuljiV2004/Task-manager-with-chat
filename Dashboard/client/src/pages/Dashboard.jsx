  ...
  return (
    <div className='w-full h-32 bg-white p-5 shadow-md rounded-md flex items-center justify-between'>
      <div className='h-full flex flex-1 flex-col justify-between'>
        ...
        <span className='text-sm text-gray-400'>{label==="COMPLETED TASK"?"Vaazhthukal broo!!!":label==="TOTAL TASK"?"Bayapudatha da Bayapudatha!!":label==="TASK IN PROGRESS "?"Unnale mudiyathu nu oorae sollum nambaathe!!!":label==="TODOS"?"Focus kabilla!!!":""}</span>
      </div>
      <div
        className={clsx(
